#include "DcmtkDemoFrameWnd.h"


CDcmtkDemoFrameWnd::CDcmtkDemoFrameWnd(void)
{
}
...
LPCTSTR CDcmtkDemoFrameWnd::GetWindowClassName() const 
{ 
	return _T("VtkDemoFrameWnd"); 
}

void CDcmtkDemoFrameWnd::OnFinalMessage(HWND hWnd)
{
	WindowImplBase::OnFinalMessage(hWnd);
	//delete this; //退出时，会有异常
}

CDuiString CDcmtkDemoFrameWnd::GetSkinFile()
{
	return _T("frame_wnd_demo\\dcmtk_demo_frame.xml");
}

CDuiString CDcmtkDemoFrameWnd::GetSkinFolder()
{
	return CDuiString(CPaintManagerUI::GetInstancePath()) + _T("skin\\");

}

CControlUI* CDcmtkDemoFrameWnd::CreateControl(LPCTSTR pstrClass)
{
	return NULL;
}

void CDcmtkDemoFrameWnd::InitWindow()
{
	
}

LRESULT CDcmtkDemoFrameWnd::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
void    CDcmtkDemoFrameWnd::Notify(TNotifyUI& msg) 
{
...
LRESULT CDcmtkDemoFrameWnd::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
void CDcmtkDemoFrameWnd::test_dcmtk()
{
	DcmFileFormat dfile;
