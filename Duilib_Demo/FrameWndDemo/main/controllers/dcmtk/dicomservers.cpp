...
void DicomServerList::Reload()
{
	...
	//GNC::GCS::ConfigurationController::Instance()->readGroupGeneral("/DeepWiseCore/PACS/Servidores", servers);
	...
	//int port;
	//GNC::GCS::ConfigurationController::Instance()->readIntGeneral("/DeepWiseCore/PACS/Local", "Puerto", port, 11112);
...
//	GNC::GCS::ConfigurationController::Instance()->readBoolGeneral("/DeepWiseCore/PACS/Local", "useTLS", LocalServer->useTLS, false);
//	GNC::GCS::ConfigurationController::Instance()->readBoolGeneral("/DeepWiseCore/PACS/Local", "verifyCredentials", LocalServer->verifyCredentials, false);
//#ifdef GINKGO_PRIVATE_KEY
//	LocalServer->privateKey = GINKGO_PRIVATE_KEY;
//#endif
//	GNC::GCS::ConfigurationController::Instance()->readStringGeneral("/DeepWiseCore/PACS/Local", "privateKey", LocalServer->privateKey);
//
//#ifdef GINKGO_PUBLIC_KEY
//	LocalServer->certificate = GINKGO_PUBLIC_KEY;
//#endif
//	GNC::GCS::ConfigurationController::Instance()->readStringGeneral("/DeepWiseCore/PACS/Local", "certificate", LocalServer->certificate);
}
