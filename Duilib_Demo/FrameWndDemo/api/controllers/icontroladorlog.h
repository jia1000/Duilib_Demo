...
{ \
	...
	if (cL != NULL) { \
        ...
        ss << "File: " << __FILE__ << " Line: " << __LINE__ << "  Log: " << logger;\
		cL->Log(ss.str(), _buf.str(), GNC::GCS::IControladorLog::FatalLog);\
	} \
}
...
{ \
	...
	if (cL != NULL) { \
        ...
        std::ostringstream ss;\
        ss << "File: " << __FILE__ << " Line: " << __LINE__ << "  Log: " << logger;\
		cL->Log(ss.str(), _buf.str(), GNC::GCS::IControladorLog::ErrorLog);\
	} \
}
...
{ \
	...
	if (cL != NULL) { \
        ...
        std::ostringstream ss;\
        ss << "File: " << __FILE__ << " Line: " << __LINE__ << "  Log: " << logger;\
		cL->Log(ss.str(), _buf.str(), GNC::GCS::IControladorLog::WarnLog);\
	} \
}
...
{ \
	...
	if (cL != NULL) { \
        ...
        std::ostringstream ss;\
        ss << "File: " << __FILE__ << " Line: " << __LINE__ << "  Log: " << logger;\
		cL->Log(ss.str(), _buf.str(), GNC::GCS::IControladorLog::InfoLog);\
	} \
}
...
{ \
	...
	if (cL != NULL && cL->IsEnabledFor(GNC::GCS::IControladorLog::DebugLog) ) { \
        ...
        std::ostringstream ss;\
        ss << "File: " << __FILE__ << " Line: " << __LINE__ << "  Log: " << logger;\
		cL->Log(ss.str(), _buf.str(), GNC::GCS::IControladorLog::DebugLog);\
	} \
}
...
{ \
	...
	if (cL != NULL && cL->IsEnabledFor(GNC::GCS::IControladorLog::TraceLog) ) { \
        ...
        std::ostringstream ss;\
        ss << "File: " << __FILE__ << " Line: " << __LINE__ << "  Log: " << logger;\
		cL->Log(ss.str(), _buf.str(), GNC::GCS::IControladorLog::TraceLog);\
	} \
}
